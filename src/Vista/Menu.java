...
public class Menu {
    ...
    public void menuVistaConsola(){
        String nombre;
        int op;
        System.out.print("Ingrese el nombre de su tienda: "); nombre = sc.nextLine();
        ...
        do{
            ...
            System.out.print("\nIngrese la opcion de su preferencia: "); op = Entrada.leerInt();
            switch(op){
                case 1: 
                    tienda.RegistrarArticulo();
                    break;
                
                case 2: tienda.RegistrarVenta(); 
                    break;
                case 3: 
                    System.out.print("\nIngrese el codigo del producto que desea actualizar: "); cod = sc.nextInt();
                    tienda.Actualizar(cod); 
                    break;
                
                case 4: 
                    System.out.print("\nIngrese el codigo del producto que desea borrar: "); cod = sc.nextInt();
                    tienda.BorrarA(cod);
                    break;
                case 5: 
                    System.out.print("\nIngrese el codigo del producto que desea consultar: "); cod = sc.nextInt();
